...
if(isset($_REQUEST['id']) && !empty($_REQUEST['id'])){
	$_SESSION['view_estimate_id']=$_REQUEST['id'];
}
    $order_id=$_SESSION['view_estimate_id'];
...
if(isset($_POST['submit']) && $_POST['submit']=='convert_to_order'){
	                
	             $order_status='order';
	
	            $update_data = array(  
                           'order_status'     =>     mysqli_real_escape_string($con, $order_status)
							);  
             ...
             <div class="col-md-6 custom-column">
               <div class="customer-details-box-single">
                 <div class="left-label">
                   <label class="form-label">Estimation Ref. No.</label>
                 </div>
           ...
           <!--div class="row">
             ...
             <div class="col-md-6 custom-column">
               <div class="customer-details-box-single">
                 ...
                 <div class="input-undi">
                   <input id="tel" type="text"  class="form-input none-bg-border" value="XXXXXXXXXX" disabled="">
                 </div>
               </div>
             </div>
           </div-->
            ...
            <div class="row">
             <div class="col-md-6 custom-column">
               <div class="customer-details-box-single">
                 ...
                 <div class="input-undi">
                   <input id="tel" type="text" placeholder="XXXXXXXXXX" class="form-input none-bg-border" value="<?php echo $rowc['credit_facilty'];?>" disabled="">
                 </div>
               </div>
             </div>
             <div class="col-md-6 custom-column">
   ...
   <div class="row my-5">
     <div class="col text-center custom-column">
      <div class="buttons-data-table many-btn">
        <a href="update_estimate.php?id=<?php echo $order_id;?>"  class="btns btn-data-table">Update Order</a>
        ...
        <a href="print_order_label.php"  class="btns btn-data-table">Convert To Order</a-->
		   <button type="submit" name='submit' value="convert_to_order" class="btns btn-data-table">Convert To Order</button>  
      </div> 
     </div>
   </div>
 </div>
