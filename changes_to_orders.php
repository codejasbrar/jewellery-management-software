<?php
 if(isset($_POST['Export']) && $_POST['Export']=='Export'){
		 ...
		 $filename = 'changes_to_orders.csv';
        ...
        <div class="bread-inner">
          ...
          <div class="header-breadcrumb-left">
            <ul>
              ...
              <li><a href="javascript:avoid()" class="white-bg">Changes to Orders</a></li>
            </ul>
          </div>
        </div>
...
<section class="all-order-result">
   ...
   <div class="customer-data-inner data-inner-single-item-box"> <!--Start data -inner single box-->
    ...
    <div class="row">
      <div class="col-md-6 text-left"><h3><strong>Updated Order Details </strong></h3></div>
...
$second_last = $total_no_of_pages - 1; // total pages minus 1
	   ...
	   $user_arr = array();
	    $user_arr[] = array('Order Ref. No.', 'Customer Name', 'Customer Phone No.', 'Order Created Date', 'Order Updated Date', 'Updated by', 'Delivery Method', 'Payment Type','Status');
	   ...
	   $order_updated_date=date("d-m-Y", strtotime($row['modified']));	   
	   ...
	   $status=$row['status'];		   
		   ...
		   $user_arr[] = array($order_id,$name,$phone_no,$order_created_date,$order_updated_date,'',$delivery_method,$payment_type,$status); 
    ...
    <tr id="tr_<?php echo $order_id;?>">
	  ...
	  <td><?php echo $order_updated_date;?></td>	
      <td></td>
