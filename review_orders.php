...
/*	 
	$excelData = $_POST['excel_export_data'];
        ...
        <div class="bread-inner">
          ...
          <div class="header-breadcrumb-left">
            <ul>
              ...
              <li><a href="javascript:avoid()" class="white-bg">Review Orders</a></li>
            </ul>
          </div>
        </div>
...
<section class="all-order-result">
   ...
   <div class="customer-data-inner data-inner-single-item-box"> <!--Start data -inner single box-->
	   ...
	   <div class="report-page-order">
    <h3><strong>Order Details </strong></h3>
    <div class="row">
    <div class="col-md-6 custom-column">
               <div class="customer-details-box-single">
                 <div class="left-label">
                   <label class="form-label">No. of Orders in Pipeline :</label>
                 </div>
                 <div class="input-undi">
                   <input id="tel" type="text" placeholder="Your telephone number" class="form-input none-bg-border" value="XXXXXXXXXX" disabled="">
                 </div>
               </div>
               
               <div class="customer-details-box-single">
                 <div class="left-label">
                   <label class="form-label">No. of Orders in Production :</label>
                 </div>
                 <div class="input-undi">
                   <input id="tel" type="text" placeholder="Your telephone number" class="form-input none-bg-border" value="XXXXXXXXXX" disabled="">
                 </div>
       ...
       <div class="col-md-6 text-right"><!--a href="#" class="btns btn-data-table">Export</a-->
    
               <input type='submit' value='Export' class="btns btn-data-table" name='Export'>
		   </div>
    </div>
...
$second_last = $total_no_of_pages - 1; // total pages minus 1
	   ...
	   //echo $sqlq;
	   $user_arr = array();
	    $user_arr[] = array('Order Ref. No.', 'Customer Name', 'Customer Phone No.', 'Order Created Date', 'Delivery Method', 'Payment Type','Price','Status');  
	   // Column names 
       $fields = array('Order Ref. No.', 'Customer Name', 'Customer Phone No.', 'Order Created Date', 'Delivery Method', 'Payment Type','Price','Status');  
	   ...
	   $total_price=number_format($row['total_price'],2);	   
		  ...
		  $user_arr[] = array($order_id,$name,$phone_no,$order_created_date,$delivery_method,$payment_type,$total_price,$status); 
		   
		  $rowData = array($order_id,$name,$phone_no,$order_created_date,$delivery_method,$payment_type,$total_price,$status); 
...
echo "<li class='page-item'><a class='page-link' href='?page_no=$total_no_of_pages'>Last &rsaquo;&rsaquo;</a></li>";
	...
	?>	
		  ...
		  <textarea name='excel_export_data' style='display: none;'><?php echo $excelData; ?></textarea>
