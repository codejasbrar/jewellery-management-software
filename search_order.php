        ...
        <div class="bread-inner">
          ...
          <div class="header-breadcrumb-left">
            <ul>
              ...
              <li><a href="javascript:avoid()" class="white-bg">All Orders</a></li>
            </ul>
          </div>
        </div>
        <div class="single-bread-box">
          <div class="buttons-data-table filter-data-table top-button">
                ...
                <a href="create_order.php?id=new"  class="btns btn-data-table"><span class="plus-create mr-2">&plus;</span>Create New Order </a>
          </div>
      </div>
        </div>
    </div>
...
$second_last = $total_no_of_pages - 1; // total pages minus 1
    ...
    <tr id="tr_<?php echo $order_id;?>">
      ...
      <td class="d-flex custom-margin">
        <a href="view_order.php?id=<?php echo $order_id;?>" class="btn btn-primary" title='Click here to view this'>
          <i class="fa fa-eye"></i>
        </a>

        <a href="update_order.php?id=<?php echo $order_id;?>" class="btn btn-primary" title='Click here to edit this'>
