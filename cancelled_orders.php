        ...
        <div class="bread-inner">
          ...
          <div class="header-breadcrumb-left">
            <ul>
              ...
              <li><a href="javascript:avoid()" class="white-bg">Cancelled Orders</a></li>
            </ul>
          </div>
        </div>
...
<section class="all-order-result">
   ...
   <div class="customer-data-inner data-inner-single-item-box"> <!--Start data -inner single box-->
    ...
    <div class="row">
      <div class="col-md-6 text-left"><h3><strong>Cancelled Order Details </strong></h3></div>
...
$second_last = $total_no_of_pages - 1; // total pages minus 1
	   ...
	   //echo $sqlq;
	    ...
	    $user_arr = array();
	    $user_arr[] = array('Order Ref. No.', 'Customer Name', 'Customer Phone No.', 'Order Created Date', 'Cancelled By', 'Delivery Method', 'Payment Type');
